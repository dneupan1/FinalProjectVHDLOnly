...
SIGNAL \pixel_buffer[3][2][0]~0_combout\ : std_logic;
...
SIGNAL \pixel_buffer[3][2][0]~1_combout\ : std_logic;
SIGNAL \pixel_buffer[3][2][1]~q\ : std_logic;
SIGNAL \pixel_buffer[2][3][0]~0_combout\ : std_logic;
SIGNAL \pixel_buffer[2][3][0]~1_combout\ : std_logic;
...
SIGNAL \ALT_INV_pixel_buffer[2][3][0]~0_combout\ : std_logic;
...
SIGNAL \ALT_INV_pixel_buffer[3][2][0]~0_combout\ : std_logic;
...
SIGNAL \ALT_INV_pixel_buffer[3][3][0]~q\ : std_logic;
...
\ALT_INV_pixel_buffer[2][3][0]~0_combout\ <= NOT \pixel_buffer[2][3][0]~0_combout\;
...
\ALT_INV_pixel_buffer[3][2][0]~0_combout\ <= NOT \pixel_buffer[3][2][0]~0_combout\;
...
\ALT_INV_pixel_buffer[3][3][0]~q\ <= NOT \pixel_buffer[3][3][0]~q\;
...
-- Equation(s):
-- \Add1~25_sumout\ = SUM(( pixel_x(6) ) + ( GND ) + ( \Add1~14\ ))
-- \Add1~26\ = CARRY(( pixel_x(6) ) + ( GND ) + ( \Add1~14\ ))
...
-- Equation(s):
-- \Add1~21_sumout\ = SUM(( pixel_x(7) ) + ( GND ) + ( \Add1~26\ ))
-- \Add1~22\ = CARRY(( pixel_x(7) ) + ( GND ) + ( \Add1~26\ ))
...
-- Equation(s):
-- \process_2~2_combout\ = (\cmos_fval~input_o\ & \cmos_lval~input_o\)
...
-- Equation(s):
-- \Add1~17_sumout\ = SUM(( pixel_x(8) ) + ( GND ) + ( \Add1~22\ ))
-- \Add1~18\ = CARRY(( pixel_x(8) ) + ( GND ) + ( \Add1~22\ ))
...
-- Equation(s):
-- \Add1~61_sumout\ = SUM(( pixel_x(9) ) + ( GND ) + ( \Add1~18\ ))
-- \Add1~62\ = CARRY(( pixel_x(9) ) + ( GND ) + ( \Add1~18\ ))
...
-- Equation(s):
-- \Add1~57_sumout\ = SUM(( pixel_x(10) ) + ( GND ) + ( \Add1~62\ ))
-- \Add1~58\ = CARRY(( pixel_x(10) ) + ( GND ) + ( \Add1~62\ ))
...
-- Equation(s):
-- \Add1~53_sumout\ = SUM(( pixel_x(11) ) + ( GND ) + ( \Add1~58\ ))
-- \Add1~54\ = CARRY(( pixel_x(11) ) + ( GND ) + ( \Add1~58\ ))
...
-- Equation(s):
-- \Add1~49_sumout\ = SUM(( pixel_x(12) ) + ( GND ) + ( \Add1~54\ ))
-- \Add1~50\ = CARRY(( pixel_x(12) ) + ( GND ) + ( \Add1~54\ ))
...
-- Equation(s):
-- \Add1~29_sumout\ = SUM(( pixel_x(13) ) + ( GND ) + ( \Add1~50\ ))
-- \Add1~30\ = CARRY(( pixel_x(13) ) + ( GND ) + ( \Add1~50\ ))
...
-- Equation(s):
-- \Add1~45_sumout\ = SUM(( pixel_x(14) ) + ( GND ) + ( \Add1~30\ ))
-- \Add1~46\ = CARRY(( pixel_x(14) ) + ( GND ) + ( \Add1~30\ ))
...
-- Equation(s):
-- \Add1~41_sumout\ = SUM(( pixel_x(15) ) + ( GND ) + ( \Add1~46\ ))
-- \Add1~42\ = CARRY(( pixel_x(15) ) + ( GND ) + ( \Add1~46\ ))
...
-- Equation(s):
-- \Add1~109_sumout\ = SUM(( pixel_x(16) ) + ( GND ) + ( \Add1~42\ ))
-- \Add1~110\ = CARRY(( pixel_x(16) ) + ( GND ) + ( \Add1~42\ ))
...
-- Equation(s):
-- \Add1~105_sumout\ = SUM(( pixel_x(17) ) + ( GND ) + ( \Add1~110\ ))
-- \Add1~106\ = CARRY(( pixel_x(17) ) + ( GND ) + ( \Add1~110\ ))
...
-- Equation(s):
-- \Add1~101_sumout\ = SUM(( pixel_x(18) ) + ( GND ) + ( \Add1~106\ ))
-- \Add1~102\ = CARRY(( pixel_x(18) ) + ( GND ) + ( \Add1~106\ ))
...
-- Equation(s):
-- \Add1~97_sumout\ = SUM(( pixel_x(19) ) + ( GND ) + ( \Add1~102\ ))
-- \Add1~98\ = CARRY(( pixel_x(19) ) + ( GND ) + ( \Add1~102\ ))
...
-- Equation(s):
-- \Add1~1_sumout\ = SUM(( pixel_x(20) ) + ( GND ) + ( \Add1~98\ ))
-- \Add1~2\ = CARRY(( pixel_x(20) ) + ( GND ) + ( \Add1~98\ ))
...
-- Equation(s):
-- \Add1~93_sumout\ = SUM(( pixel_x(21) ) + ( GND ) + ( \Add1~2\ ))
-- \Add1~94\ = CARRY(( pixel_x(21) ) + ( GND ) + ( \Add1~2\ ))
...
-- Equation(s):
-- \Add1~89_sumout\ = SUM(( pixel_x(22) ) + ( GND ) + ( \Add1~94\ ))
-- \Add1~90\ = CARRY(( pixel_x(22) ) + ( GND ) + ( \Add1~94\ ))
...
-- Equation(s):
-- \Equal0~4_combout\ = ( !pixel_x(19) & ( !pixel_x(16) & ( (!pixel_x(21) & (!pixel_x(22) & (!pixel_x(18) & !pixel_x(17)))) ) ) )
...
PORT MAP (
	...
	datab => ALT_INV_pixel_x(22),
	datac => ALT_INV_pixel_x(18),
	datad => ALT_INV_pixel_x(17),
	datae => ALT_INV_pixel_x(19),
	dataf => ALT_INV_pixel_x(16),
	combout => \Equal0~4_combout\);

-- Location: MLABCELL_X65_Y5_N9
\Add1~85\ : cyclonev_lcell_comb
-- Equation(s):
-- \Add1~85_sumout\ = SUM(( pixel_x(23) ) + ( GND ) + ( \Add1~90\ ))
-- \Add1~86\ = CARRY(( pixel_x(23) ) + ( GND ) + ( \Add1~90\ ))
...
-- Equation(s):
-- \Add1~81_sumout\ = SUM(( pixel_x(24) ) + ( GND ) + ( \Add1~86\ ))
-- \Add1~82\ = CARRY(( pixel_x(24) ) + ( GND ) + ( \Add1~86\ ))
...
-- Equation(s):
-- \Add1~77_sumout\ = SUM(( pixel_x(25) ) + ( GND ) + ( \Add1~82\ ))
-- \Add1~78\ = CARRY(( pixel_x(25) ) + ( GND ) + ( \Add1~82\ ))
...
-- Equation(s):
-- \Add1~73_sumout\ = SUM(( pixel_x(26) ) + ( GND ) + ( \Add1~78\ ))
-- \Add1~74\ = CARRY(( pixel_x(26) ) + ( GND ) + ( \Add1~78\ ))
...
-- Equation(s):
-- \Add1~69_sumout\ = SUM(( pixel_x(27) ) + ( GND ) + ( \Add1~74\ ))
-- \Add1~70\ = CARRY(( pixel_x(27) ) + ( GND ) + ( \Add1~74\ ))
...
-- Equation(s):
-- \Add1~65_sumout\ = SUM(( pixel_x(28) ) + ( GND ) + ( \Add1~70\ ))
-- \Add1~66\ = CARRY(( pixel_x(28) ) + ( GND ) + ( \Add1~70\ ))
...
-- Equation(s):
-- \Equal0~3_combout\ = ( !pixel_x(25) & ( !pixel_x(28) & ( (!pixel_x(27) & (!pixel_x(23) & (!pixel_x(26) & !pixel_x(24)))) ) ) )
...
PORT MAP (
	...
	dataf => ALT_INV_pixel_x(28),
	combout => \Equal0~3_combout\);

-- Location: MLABCELL_X65_Y5_N27
\Add1~9\ : cyclonev_lcell_comb
-- Equation(s):
-- \Add1~9_sumout\ = SUM(( pixel_x(29) ) + ( GND ) + ( \Add1~66\ ))
-- \Add1~10\ = CARRY(( pixel_x(29) ) + ( GND ) + ( \Add1~66\ ))
...
-- Equation(s):
-- \Add1~5_sumout\ = SUM(( pixel_x(30) ) + ( GND ) + ( \Add1~10\ ))
-- \Add1~6\ = CARRY(( pixel_x(30) ) + ( GND ) + ( \Add1~10\ ))
...
-- Equation(s):
-- \Add1~125_sumout\ = SUM(( pixel_x(31) ) + ( GND ) + ( \Add1~6\ ))
...
-- Equation(s):
-- \Equal0~5_combout\ = ( !pixel_x(1) & ( (pixel_x(2) & (!pixel_x(0) & !pixel_x(31))) ) )
...
PORT MAP (
	...
	dataf => ALT_INV_pixel_x(1),
	combout => \Equal0~5_combout\);

-- Location: MLABCELL_X65_Y5_N48
\Equal0~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \Equal0~0_combout\ = ( !pixel_x(29) & ( !pixel_x(5) & ( (!pixel_x(20) & !pixel_x(30)) ) ) )
...
-- Equation(s):
-- \Equal0~2_combout\ = ( !pixel_x(15) & ( !pixel_x(10) & ( (!pixel_x(12) & (!pixel_x(14) & (!pixel_x(11) & !pixel_x(9)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => ALT_INV_pixel_x(12),
	datab => ALT_INV_pixel_x(14),
	datac => ALT_INV_pixel_x(11),
	datad => ALT_INV_pixel_x(9),
	datae => ALT_INV_pixel_x(15),
	dataf => ALT_INV_pixel_x(10),
	combout => \Equal0~2_combout\);

-- Location: LABCELL_X66_Y7_N24
\Equal0~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \Equal0~6_combout\ = ( \Equal0~2_combout\ & ( \Equal0~1_combout\ & ( (\Equal0~4_combout\ & (\Equal0~3_combout\ & (\Equal0~5_combout\ & \Equal0~0_combout\))) ) ) )
...
-- Equation(s):
-- \Add1~113_sumout\ = SUM(( pixel_x(1) ) + ( GND ) + ( \Add1~118\ ))
-- \Add1~114\ = CARRY(( pixel_x(1) ) + ( GND ) + ( \Add1~118\ ))
...
-- Equation(s):
-- \Add1~121_sumout\ = SUM(( pixel_x(2) ) + ( GND ) + ( \Add1~114\ ))
-- \Add1~122\ = CARRY(( pixel_x(2) ) + ( GND ) + ( \Add1~114\ ))
...
-- Equation(s):
-- \Add1~37_sumout\ = SUM(( pixel_x(3) ) + ( GND ) + ( \Add1~122\ ))
-- \Add1~38\ = CARRY(( pixel_x(3) ) + ( GND ) + ( \Add1~122\ ))
...
-- Equation(s):
-- \Add1~33_sumout\ = SUM(( pixel_x(4) ) + ( GND ) + ( \Add1~38\ ))
-- \Add1~34\ = CARRY(( pixel_x(4) ) + ( GND ) + ( \Add1~38\ ))
...
-- Equation(s):
-- \Add1~13_sumout\ = SUM(( pixel_x(5) ) + ( GND ) + ( \Add1~34\ ))
-- \Add1~14\ = CARRY(( pixel_x(5) ) + ( GND ) + ( \Add1~34\ ))
...
-- Equation(s):
-- \Equal0~1_combout\ = ( !pixel_x(8) & ( !pixel_x(7) & ( (!pixel_x(6) & (!pixel_x(3) & (!pixel_x(13) & !pixel_x(4)))) ) ) )
...
-- Equation(s):
-- \process_2~0_combout\ = ( \Equal0~3_combout\ & ( \Equal0~4_combout\ & ( (\Equal0~1_combout\ & (\Equal0~2_combout\ & (\Equal0~0_combout\ & !pixel_x(2)))) ) ) )
...
-- Equation(s):
-- \Equal1~3_combout\ = ( !pixel_y(22) & ( !pixel_y(24) & ( (!pixel_y(21) & (!pixel_y(23) & (!pixel_y(26) & !pixel_y(25)))) ) ) )
...
-- Equation(s):
-- \Equal1~4_combout\ = ( !pixel_y(16) & ( !pixel_y(20) & ( (!pixel_y(17) & (!pixel_y(19) & (!pixel_y(15) & !pixel_y(18)))) ) ) )
...
-- Equation(s):
-- \Equal1~5_combout\ = ( !pixel_y(1) & ( !pixel_y(31) & ( (pixel_y(2) & !pixel_y(0)) ) ) )
...
-- Equation(s):
-- \Equal1~0_combout\ = ( !pixel_y(29) & ( !pixel_y(28) & ( (!pixel_y(27) & !pixel_y(30)) ) ) )
...
-- Equation(s):
-- \Equal1~1_combout\ = ( !pixel_y(7) & ( !pixel_y(8) & ( (!pixel_y(5) & (!pixel_y(6) & (!pixel_y(3) & !pixel_y(4)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => ALT_INV_pixel_y(5),
	datab => ALT_INV_pixel_y(6),
...
-- Equation(s):
-- \Equal1~6_combout\ = ( \Equal1~0_combout\ & ( \Equal1~1_combout\ & ( (\Equal1~3_combout\ & (\Equal1~2_combout\ & (\Equal1~4_combout\ & \Equal1~5_combout\))) ) ) )
...
-- Equation(s):
-- \pixel_y[31]~0_combout\ = ( \Equal0~6_combout\ & ( (\cmos_fval~input_o\ & \cmos_lval~input_o\) ) )
...
PORT MAP (
	...
	datad => \ALT_INV_cmos_lval~input_o\,
...
-- Equation(s):
-- \Add2~37_sumout\ = SUM(( pixel_y(3) ) + ( GND ) + ( \Add2~114\ ))
-- \Add2~38\ = CARRY(( pixel_y(3) ) + ( GND ) + ( \Add2~114\ ))
...
-- Equation(s):
-- \Add2~33_sumout\ = SUM(( pixel_y(4) ) + ( GND ) + ( \Add2~38\ ))
-- \Add2~34\ = CARRY(( pixel_y(4) ) + ( GND ) + ( \Add2~38\ ))
...
-- Equation(s):
-- \Add2~29_sumout\ = SUM(( pixel_y(5) ) + ( GND ) + ( \Add2~34\ ))
-- \Add2~30\ = CARRY(( pixel_y(5) ) + ( GND ) + ( \Add2~34\ ))
...
-- Equation(s):
-- \Add2~25_sumout\ = SUM(( pixel_y(6) ) + ( GND ) + ( \Add2~30\ ))
-- \Add2~26\ = CARRY(( pixel_y(6) ) + ( GND ) + ( \Add2~30\ ))
...
-- Equation(s):
-- \Add2~21_sumout\ = SUM(( pixel_y(7) ) + ( GND ) + ( \Add2~26\ ))
-- \Add2~22\ = CARRY(( pixel_y(7) ) + ( GND ) + ( \Add2~26\ ))
...
-- Equation(s):
-- \Add2~17_sumout\ = SUM(( pixel_y(8) ) + ( GND ) + ( \Add2~22\ ))
-- \Add2~18\ = CARRY(( pixel_y(8) ) + ( GND ) + ( \Add2~22\ ))
...
-- Equation(s):
-- \Add2~61_sumout\ = SUM(( pixel_y(9) ) + ( GND ) + ( \Add2~18\ ))
-- \Add2~62\ = CARRY(( pixel_y(9) ) + ( GND ) + ( \Add2~18\ ))
...
-- Equation(s):
-- \Add2~57_sumout\ = SUM(( pixel_y(10) ) + ( GND ) + ( \Add2~62\ ))
-- \Add2~58\ = CARRY(( pixel_y(10) ) + ( GND ) + ( \Add2~62\ ))
...
-- Equation(s):
-- \Add2~53_sumout\ = SUM(( pixel_y(11) ) + ( GND ) + ( \Add2~58\ ))
-- \Add2~54\ = CARRY(( pixel_y(11) ) + ( GND ) + ( \Add2~58\ ))
...
-- Equation(s):
-- \Add2~49_sumout\ = SUM(( pixel_y(12) ) + ( GND ) + ( \Add2~54\ ))
-- \Add2~50\ = CARRY(( pixel_y(12) ) + ( GND ) + ( \Add2~54\ ))
...
-- Equation(s):
-- \Add2~45_sumout\ = SUM(( pixel_y(13) ) + ( GND ) + ( \Add2~50\ ))
-- \Add2~46\ = CARRY(( pixel_y(13) ) + ( GND ) + ( \Add2~50\ ))
...
-- Equation(s):
-- \Add2~41_sumout\ = SUM(( pixel_y(14) ) + ( GND ) + ( \Add2~46\ ))
-- \Add2~42\ = CARRY(( pixel_y(14) ) + ( GND ) + ( \Add2~46\ ))
...
-- Equation(s):
-- \Add2~109_sumout\ = SUM(( pixel_y(15) ) + ( GND ) + ( \Add2~42\ ))
-- \Add2~110\ = CARRY(( pixel_y(15) ) + ( GND ) + ( \Add2~42\ ))
...
-- Equation(s):
-- \Add2~105_sumout\ = SUM(( pixel_y(16) ) + ( GND ) + ( \Add2~110\ ))
-- \Add2~106\ = CARRY(( pixel_y(16) ) + ( GND ) + ( \Add2~110\ ))
...
-- Equation(s):
-- \Add2~101_sumout\ = SUM(( pixel_y(17) ) + ( GND ) + ( \Add2~106\ ))
-- \Add2~102\ = CARRY(( pixel_y(17) ) + ( GND ) + ( \Add2~106\ ))
...
-- Equation(s):
-- \Add2~97_sumout\ = SUM(( pixel_y(18) ) + ( GND ) + ( \Add2~102\ ))
-- \Add2~98\ = CARRY(( pixel_y(18) ) + ( GND ) + ( \Add2~102\ ))
...
-- Equation(s):
-- \Add2~93_sumout\ = SUM(( pixel_y(19) ) + ( GND ) + ( \Add2~98\ ))
-- \Add2~94\ = CARRY(( pixel_y(19) ) + ( GND ) + ( \Add2~98\ ))
...
-- Equation(s):
-- \Add2~89_sumout\ = SUM(( pixel_y(20) ) + ( GND ) + ( \Add2~94\ ))
-- \Add2~90\ = CARRY(( pixel_y(20) ) + ( GND ) + ( \Add2~94\ ))
...
-- Equation(s):
-- \Add2~85_sumout\ = SUM(( pixel_y(21) ) + ( GND ) + ( \Add2~90\ ))
-- \Add2~86\ = CARRY(( pixel_y(21) ) + ( GND ) + ( \Add2~90\ ))
...
-- Equation(s):
-- \Add2~81_sumout\ = SUM(( pixel_y(22) ) + ( GND ) + ( \Add2~86\ ))
-- \Add2~82\ = CARRY(( pixel_y(22) ) + ( GND ) + ( \Add2~86\ ))
...
-- Equation(s):
-- \Add2~77_sumout\ = SUM(( pixel_y(23) ) + ( GND ) + ( \Add2~82\ ))
-- \Add2~78\ = CARRY(( pixel_y(23) ) + ( GND ) + ( \Add2~82\ ))
...
-- Equation(s):
-- \Add2~73_sumout\ = SUM(( pixel_y(24) ) + ( GND ) + ( \Add2~78\ ))
-- \Add2~74\ = CARRY(( pixel_y(24) ) + ( GND ) + ( \Add2~78\ ))
...
-- Equation(s):
-- \Add2~69_sumout\ = SUM(( pixel_y(25) ) + ( GND ) + ( \Add2~74\ ))
-- \Add2~70\ = CARRY(( pixel_y(25) ) + ( GND ) + ( \Add2~74\ ))
...
-- Equation(s):
-- \Add2~65_sumout\ = SUM(( pixel_y(26) ) + ( GND ) + ( \Add2~70\ ))
-- \Add2~66\ = CARRY(( pixel_y(26) ) + ( GND ) + ( \Add2~70\ ))
...
-- Equation(s):
-- \Add2~13_sumout\ = SUM(( pixel_y(27) ) + ( GND ) + ( \Add2~66\ ))
-- \Add2~14\ = CARRY(( pixel_y(27) ) + ( GND ) + ( \Add2~66\ ))
...
-- Equation(s):
-- \Add2~9_sumout\ = SUM(( pixel_y(28) ) + ( GND ) + ( \Add2~14\ ))
-- \Add2~10\ = CARRY(( pixel_y(28) ) + ( GND ) + ( \Add2~14\ ))
...
-- Equation(s):
-- \Add2~5_sumout\ = SUM(( pixel_y(29) ) + ( GND ) + ( \Add2~10\ ))
-- \Add2~6\ = CARRY(( pixel_y(29) ) + ( GND ) + ( \Add2~10\ ))
...
-- Equation(s):
-- \Add2~1_sumout\ = SUM(( pixel_y(30) ) + ( GND ) + ( \Add2~6\ ))
-- \Add2~2\ = CARRY(( pixel_y(30) ) + ( GND ) + ( \Add2~6\ ))
...
-- Equation(s):
-- \Add2~125_sumout\ = SUM(( pixel_y(31) ) + ( GND ) + ( \Add2~2\ ))
...
-- Equation(s):
-- \LessThan2~0_combout\ = ( \Equal1~1_combout\ & ( \Equal1~4_combout\ & ( (!pixel_y(2) & (\Equal1~3_combout\ & (\Equal1~2_combout\ & \Equal1~0_combout\))) ) ) )
...
-- Equation(s):
-- \LEDR[0]~1_combout\ = ( \LEDR[0]~reg0_q\ & ( \LEDR[0]~0_combout\ & ( (!\cmos_lval~input_o\) # (!\cmos_fval~input_o\) ) ) ) # ( \LEDR[0]~reg0_q\ & ( !\LEDR[0]~0_combout\ ) ) # ( !\LEDR[0]~reg0_q\ & ( !\LEDR[0]~0_combout\ & ( (\cmos_lval~input_o\ & 
-- (!\process_2~1_combout\ & (\cmos_fval~input_o\ & !\LessThan2~1_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010000000000111111111111111100000000000000001111101011111010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_cmos_lval~input_o\,
	datab => \ALT_INV_process_2~1_combout\,
	datac => \ALT_INV_cmos_fval~input_o\,
...
\pixel_buffer[3][2][0]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \pixel_buffer[3][2][0]~0_combout\ = ( pixel_y(1) & ( pixel_x(1) ) )
...
PORT MAP (
	...
	combout => \pixel_buffer[3][2][0]~0_combout\);

-- Location: LABCELL_X66_Y6_N12
\LEDR[0]~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \LEDR[0]~3_combout\ = ( \process_2~0_combout\ & ( \LessThan2~0_combout\ & ( (\cmos_lval~input_o\ & \cmos_fval~input_o\) ) ) ) # ( !\process_2~0_combout\ & ( \LessThan2~0_combout\ & ( (\cmos_lval~input_o\ & (\cmos_fval~input_o\ & pixel_x(31))) ) ) ) # ( 
-- \process_2~0_combout\ & ( !\LessThan2~0_combout\ & ( (\cmos_lval~input_o\ & (\cmos_fval~input_o\ & pixel_y(31))) ) ) ) # ( !\process_2~0_combout\ & ( !\LessThan2~0_combout\ & ( (\cmos_lval~input_o\ & (\cmos_fval~input_o\ & (pixel_x(31) & pixel_y(31)))) ) 
-- ) )
...
-- Equation(s):
-- \pixel_buffer[3][3][0]~0_combout\ = ( \LEDR[0]~3_combout\ & ( (pixel_y(0) & (pixel_x(0) & \pixel_buffer[3][2][0]~0_combout\)) ) )
...
PORT MAP (
	...
	datac => \ALT_INV_pixel_buffer[3][2][0]~0_combout\,
...
-- Equation(s):
-- \LEDR[1]~reg0feeder_combout\ = ( \pixel_buffer[3][3][0]~q\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \ALT_INV_pixel_buffer[3][3][0]~q\,
	combout => \LEDR[1]~reg0feeder_combout\);

-- Location: LABCELL_X66_Y7_N6
\LEDR[1]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \LEDR[1]~2_combout\ = ( \cmos_lval~input_o\ & ( \Equal1~6_combout\ & ( (\cmos_fval~input_o\ & \Equal0~6_combout\) ) ) )
...
PORT MAP (
	datab => \ALT_INV_cmos_fval~input_o\,
	datac => \ALT_INV_Equal0~6_combout\,
	datae => \ALT_INV_cmos_lval~input_o\,
	dataf => \ALT_INV_Equal1~6_combout\,
...
\pixel_buffer[3][2][0]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \pixel_buffer[3][2][0]~1_combout\ = ( \LEDR[0]~3_combout\ & ( (\pixel_buffer[3][2][0]~0_combout\ & (pixel_x(0) & !pixel_y(0))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_pixel_buffer[3][2][0]~0_combout\,
	datab => ALT_INV_pixel_x(0),
	datac => ALT_INV_pixel_y(0),
	dataf => \ALT_INV_LEDR[0]~3_combout\,
	combout => \pixel_buffer[3][2][0]~1_combout\);
...
PORT MAP (
	...
	asdata => \CMOS_IN[1]~input_o\,
	sload => VCC,
	ena => \pixel_buffer[3][2][0]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \pixel_buffer[3][2][1]~q\);

-- Location: LABCELL_X67_Y6_N39
\pixel_buffer[2][3][0]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \pixel_buffer[2][3][0]~0_combout\ = ( !pixel_x(0) & ( pixel_y(0) ) )
...
-- pragma translate_on
PORT MAP (
	datae => ALT_INV_pixel_x(0),
	dataf => ALT_INV_pixel_y(0),
	combout => \pixel_buffer[2][3][0]~0_combout\);

-- Location: LABCELL_X66_Y6_N51
\pixel_buffer[2][3][0]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \pixel_buffer[2][3][0]~1_combout\ = ( !\process_2~1_combout\ & ( !\LessThan2~1_combout\ & ( (\cmos_lval~input_o\ & (\cmos_fval~input_o\ & (\pixel_buffer[2][3][0]~0_combout\ & \pixel_buffer[3][2][0]~0_combout\))) ) ) )
...
PORT MAP (
	dataa => \ALT_INV_cmos_lval~input_o\,
	datab => \ALT_INV_cmos_fval~input_o\,
	datac => \ALT_INV_pixel_buffer[2][3][0]~0_combout\,
	datad => \ALT_INV_pixel_buffer[3][2][0]~0_combout\,
	datae => \ALT_INV_process_2~1_combout\,
	dataf => \ALT_INV_LessThan2~1_combout\,
	combout => \pixel_buffer[2][3][0]~1_combout\);
...
PORT MAP (
	...
	asdata => \CMOS_IN[1]~input_o\,
	sload => VCC,
	ena => \pixel_buffer[2][3][0]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	datab => \ALT_INV_pixel_buffer[2][3][0]~q\,
...
-- Equation(s):
-- \Add3~5_sumout\ = SUM(( \pixel_buffer[3][2][2]~q\ ) + ( \pixel_buffer[2][3][2]~q\ ) + ( \Add3~2\ ))
-- \Add3~6\ = CARRY(( \pixel_buffer[3][2][2]~q\ ) + ( \pixel_buffer[2][3][2]~q\ ) + ( \Add3~2\ ))
...
-- pragma translate_on
PORT MAP (
	datab => \ALT_INV_pixel_buffer[2][3][2]~q\,
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_pixel_buffer[2][3][3]~q\,
...
\LEDR[7]~reg0feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \LEDR[7]~reg0feeder_combout\ = ( \pixel_buffer[3][3][0]~q\ )
...
-- Equation(s):
-- \Add4~125_sumout\ = SUM(( hsync_counter(0) ) + ( VCC ) + ( !VCC ))
-- \Add4~126\ = CARRY(( hsync_counter(0) ) + ( VCC ) + ( !VCC ))
...
-- Equation(s):
-- \Add4~45_sumout\ = SUM(( hsync_counter(12) ) + ( GND ) + ( \Add4~50\ ))
-- \Add4~46\ = CARRY(( hsync_counter(12) ) + ( GND ) + ( \Add4~50\ ))
...
-- Equation(s):
-- \Add4~41_sumout\ = SUM(( \hsync_counter[13]~DUPLICATE_q\ ) + ( GND ) + ( \Add4~46\ ))
-- \Add4~42\ = CARRY(( \hsync_counter[13]~DUPLICATE_q\ ) + ( GND ) + ( \Add4~46\ ))
...
-- Equation(s):
-- \Add4~33_sumout\ = SUM(( hsync_counter(15) ) + ( GND ) + ( \Add4~38\ ))
-- \Add4~34\ = CARRY(( hsync_counter(15) ) + ( GND ) + ( \Add4~38\ ))
...
-- pragma translate_on
PORT MAP (
	datad => ALT_INV_hsync_counter(15),
	cin => \Add4~38\,
...
-- Equation(s):
-- \Add4~97_sumout\ = SUM(( hsync_counter(17) ) + ( GND ) + ( \Add4~30\ ))
-- \Add4~98\ = CARRY(( hsync_counter(17) ) + ( GND ) + ( \Add4~30\ ))
...
-- Equation(s):
-- \Add4~93_sumout\ = SUM(( hsync_counter(18) ) + ( GND ) + ( \Add4~98\ ))
-- \Add4~94\ = CARRY(( hsync_counter(18) ) + ( GND ) + ( \Add4~98\ ))
...
-- Equation(s):
-- \Add4~89_sumout\ = SUM(( hsync_counter(19) ) + ( GND ) + ( \Add4~94\ ))
-- \Add4~90\ = CARRY(( hsync_counter(19) ) + ( GND ) + ( \Add4~94\ ))
...
-- pragma translate_on
PORT MAP (
	datac => ALT_INV_hsync_counter(19),
	cin => \Add4~94\,
...
-- Equation(s):
-- \Add4~85_sumout\ = SUM(( hsync_counter(20) ) + ( GND ) + ( \Add4~90\ ))
-- \Add4~86\ = CARRY(( hsync_counter(20) ) + ( GND ) + ( \Add4~90\ ))
...
-- Equation(s):
-- \Add4~81_sumout\ = SUM(( hsync_counter(21) ) + ( GND ) + ( \Add4~86\ ))
-- \Add4~82\ = CARRY(( hsync_counter(21) ) + ( GND ) + ( \Add4~86\ ))
...
-- Equation(s):
-- \Add4~77_sumout\ = SUM(( hsync_counter(22) ) + ( GND ) + ( \Add4~82\ ))
-- \Add4~78\ = CARRY(( hsync_counter(22) ) + ( GND ) + ( \Add4~82\ ))
...
-- pragma translate_on
PORT MAP (
	datab => ALT_INV_hsync_counter(22),
	cin => \Add4~82\,
...
-- Equation(s):
-- \Equal2~3_combout\ = ( !hsync_counter(21) & ( !hsync_counter(19) & ( (!hsync_counter(22) & (!hsync_counter(20) & (!hsync_counter(18) & !hsync_counter(17)))) ) ) )
...
PORT MAP (
	...
	dataf => ALT_INV_hsync_counter(19),
...
-- Equation(s):
-- \Equal2~4_combout\ = ( !\hsync_counter[3]~DUPLICATE_q\ & ( !hsync_counter(4) ) )
...
-- Equation(s):
-- \Add4~73_sumout\ = SUM(( hsync_counter(23) ) + ( GND ) + ( \Add4~78\ ))
-- \Add4~74\ = CARRY(( hsync_counter(23) ) + ( GND ) + ( \Add4~78\ ))
...
-- Equation(s):
-- \Add4~69_sumout\ = SUM(( hsync_counter(24) ) + ( GND ) + ( \Add4~74\ ))
-- \Add4~70\ = CARRY(( hsync_counter(24) ) + ( GND ) + ( \Add4~74\ ))
...
-- Equation(s):
-- \Add4~65_sumout\ = SUM(( hsync_counter(25) ) + ( GND ) + ( \Add4~70\ ))
-- \Add4~66\ = CARRY(( hsync_counter(25) ) + ( GND ) + ( \Add4~70\ ))
...
-- Equation(s):
-- \Add4~61_sumout\ = SUM(( hsync_counter(26) ) + ( GND ) + ( \Add4~66\ ))
-- \Add4~62\ = CARRY(( hsync_counter(26) ) + ( GND ) + ( \Add4~66\ ))
...
-- Equation(s):
-- \Add4~57_sumout\ = SUM(( hsync_counter(27) ) + ( GND ) + ( \Add4~62\ ))
-- \Add4~58\ = CARRY(( hsync_counter(27) ) + ( GND ) + ( \Add4~62\ ))
...
-- pragma translate_on
PORT MAP (
	datad => ALT_INV_hsync_counter(27),
	cin => \Add4~62\,
...
-- Equation(s):
-- \Add4~53_sumout\ = SUM(( hsync_counter(28) ) + ( GND ) + ( \Add4~58\ ))
-- \Add4~54\ = CARRY(( hsync_counter(28) ) + ( GND ) + ( \Add4~58\ ))
...
-- Equation(s):
-- \Equal2~2_combout\ = ( !hsync_counter(27) & ( !hsync_counter(25) & ( (!hsync_counter(28) & (!hsync_counter(23) & (!hsync_counter(26) & !hsync_counter(24)))) ) ) )
...
PORT MAP (
	...
	datac => ALT_INV_hsync_counter(26),
	datad => ALT_INV_hsync_counter(24),
...
-- Equation(s):
-- \Add4~25_sumout\ = SUM(( hsync_counter(29) ) + ( GND ) + ( \Add4~54\ ))
-- \Add4~26\ = CARRY(( hsync_counter(29) ) + ( GND ) + ( \Add4~54\ ))
...
-- pragma translate_on
PORT MAP (
	datad => ALT_INV_hsync_counter(29),
	cin => \Add4~54\,
...
-- Equation(s):
-- \Add4~21_sumout\ = SUM(( hsync_counter(30) ) + ( GND ) + ( \Add4~26\ ))
-- \Add4~22\ = CARRY(( hsync_counter(30) ) + ( GND ) + ( \Add4~26\ ))
...
-- Equation(s):
-- \Equal2~0_combout\ = ( !hsync_counter(8) & ( !hsync_counter(7) & ( (!hsync_counter(30) & (!hsync_counter(6) & (!hsync_counter(29) & !hsync_counter(9)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => ALT_INV_hsync_counter(30),
	datab => ALT_INV_hsync_counter(6),
	datac => ALT_INV_hsync_counter(29),
	datad => ALT_INV_hsync_counter(9),
	datae => ALT_INV_hsync_counter(8),
	dataf => ALT_INV_hsync_counter(7),
	combout => \Equal2~0_combout\);

-- Location: LABCELL_X57_Y1_N33
\Add4~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \Add4~1_sumout\ = SUM(( hsync_counter(31) ) + ( GND ) + ( \Add4~22\ ))
...
-- Equation(s):
-- \Equal2~5_combout\ = ( hsync_counter(10) & ( !hsync_counter(0) & ( (!hsync_counter(31) & (hsync_counter(5) & (!\hsync_counter[1]~DUPLICATE_q\ & !\hsync_counter[2]~DUPLICATE_q\))) ) ) )
...
PORT MAP (
	dataa => ALT_INV_hsync_counter(31),
	datab => ALT_INV_hsync_counter(5),
	datac => \ALT_INV_hsync_counter[1]~DUPLICATE_q\,
	datad => \ALT_INV_hsync_counter[2]~DUPLICATE_q\,
	datae => ALT_INV_hsync_counter(10),
	dataf => ALT_INV_hsync_counter(0),
	combout => \Equal2~5_combout\);

-- Location: LABCELL_X56_Y1_N39
\Equal2~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \Equal2~6_combout\ = ( \Equal2~5_combout\ & ( \Equal2~1_combout\ & ( (\Equal2~3_combout\ & (\Equal2~4_combout\ & (\Equal2~2_combout\ & \Equal2~0_combout\))) ) ) )
...
-- Equation(s):
-- \Add4~121_sumout\ = SUM(( hsync_counter(1) ) + ( GND ) + ( \Add4~126\ ))
-- \Add4~122\ = CARRY(( hsync_counter(1) ) + ( GND ) + ( \Add4~126\ ))
...
-- Equation(s):
-- \Add4~117_sumout\ = SUM(( hsync_counter(2) ) + ( GND ) + ( \Add4~122\ ))
-- \Add4~118\ = CARRY(( hsync_counter(2) ) + ( GND ) + ( \Add4~122\ ))
...
-- Equation(s):
-- \Add4~109_sumout\ = SUM(( hsync_counter(3) ) + ( GND ) + ( \Add4~118\ ))
-- \Add4~110\ = CARRY(( hsync_counter(3) ) + ( GND ) + ( \Add4~118\ ))
...
-- Equation(s):
-- \Add4~17_sumout\ = SUM(( hsync_counter(6) ) + ( GND ) + ( \Add4~102\ ))
-- \Add4~18\ = CARRY(( hsync_counter(6) ) + ( GND ) + ( \Add4~102\ ))
...
-- Equation(s):
-- \Add4~13_sumout\ = SUM(( \hsync_counter[7]~DUPLICATE_q\ ) + ( GND ) + ( \Add4~18\ ))
-- \Add4~14\ = CARRY(( \hsync_counter[7]~DUPLICATE_q\ ) + ( GND ) + ( \Add4~18\ ))
...
-- Equation(s):
-- \Add4~9_sumout\ = SUM(( \hsync_counter[8]~DUPLICATE_q\ ) + ( GND ) + ( \Add4~14\ ))
-- \Add4~10\ = CARRY(( \hsync_counter[8]~DUPLICATE_q\ ) + ( GND ) + ( \Add4~14\ ))
...
-- Equation(s):
-- \Add4~5_sumout\ = SUM(( hsync_counter(9) ) + ( GND ) + ( \Add4~10\ ))
-- \Add4~6\ = CARRY(( hsync_counter(9) ) + ( GND ) + ( \Add4~10\ ))
...
-- Equation(s):
-- \Add4~113_sumout\ = SUM(( hsync_counter(10) ) + ( GND ) + ( \Add4~6\ ))
-- \Add4~114\ = CARRY(( hsync_counter(10) ) + ( GND ) + ( \Add4~6\ ))
...
-- Equation(s):
-- \Add4~49_sumout\ = SUM(( hsync_counter(11) ) + ( GND ) + ( \Add4~114\ ))
-- \Add4~50\ = CARRY(( hsync_counter(11) ) + ( GND ) + ( \Add4~114\ ))
...
-- Equation(s):
-- \Equal2~1_combout\ = ( !hsync_counter(14) & ( !hsync_counter(16) & ( (!hsync_counter(12) & (!hsync_counter(15) & (!hsync_counter(11) & !hsync_counter(13)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => ALT_INV_hsync_counter(12),
	datab => ALT_INV_hsync_counter(15),
...
-- Equation(s):
-- \LessThan3~0_combout\ = (!hsync_counter(10) & ((!hsync_counter(5)) # ((!\hsync_counter[3]~DUPLICATE_q\ & !hsync_counter(4)))))
...
-- Equation(s):
-- \LessThan3~1_combout\ = ( \Equal2~2_combout\ & ( !hsync_counter(31) & ( (!\Equal2~1_combout\) # ((!\LessThan3~0_combout\) # ((!\Equal2~0_combout\) # (!\Equal2~3_combout\))) ) ) ) # ( !\Equal2~2_combout\ & ( !hsync_counter(31) ) )
...
-- Equation(s):
-- \Add5~125_sumout\ = SUM(( vsync_counter(0) ) + ( VCC ) + ( !VCC ))
-- \Add5~126\ = CARRY(( vsync_counter(0) ) + ( VCC ) + ( !VCC ))
...
-- Equation(s):
-- \Add5~121_sumout\ = SUM(( vsync_counter(1) ) + ( GND ) + ( \Add5~126\ ))
-- \Add5~122\ = CARRY(( vsync_counter(1) ) + ( GND ) + ( \Add5~126\ ))
...
-- Equation(s):
-- \Add5~9_sumout\ = SUM(( vsync_counter(2) ) + ( GND ) + ( \Add5~122\ ))
-- \Add5~10\ = CARRY(( vsync_counter(2) ) + ( GND ) + ( \Add5~122\ ))
...
-- Equation(s):
-- \Add5~5_sumout\ = SUM(( vsync_counter(3) ) + ( GND ) + ( \Add5~10\ ))
-- \Add5~6\ = CARRY(( vsync_counter(3) ) + ( GND ) + ( \Add5~10\ ))
...
-- Equation(s):
-- \Add5~1_sumout\ = SUM(( vsync_counter(4) ) + ( GND ) + ( \Add5~6\ ))
-- \Add5~2\ = CARRY(( vsync_counter(4) ) + ( GND ) + ( \Add5~6\ ))
...
-- Equation(s):
-- \Add5~33_sumout\ = SUM(( vsync_counter(5) ) + ( GND ) + ( \Add5~2\ ))
-- \Add5~34\ = CARRY(( vsync_counter(5) ) + ( GND ) + ( \Add5~2\ ))
...
-- Equation(s):
-- \Add5~29_sumout\ = SUM(( \vsync_counter[6]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~34\ ))
-- \Add5~30\ = CARRY(( \vsync_counter[6]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~34\ ))
...
-- Equation(s):
-- \Add5~73_sumout\ = SUM(( \vsync_counter[7]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~30\ ))
-- \Add5~74\ = CARRY(( \vsync_counter[7]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~30\ ))
...
-- pragma translate_on
PORT MAP (
	datad => \ALT_INV_vsync_counter[7]~DUPLICATE_q\,
	cin => \Add5~30\,
...
-- Equation(s):
-- \Add5~69_sumout\ = SUM(( \vsync_counter[8]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~74\ ))
-- \Add5~70\ = CARRY(( \vsync_counter[8]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~74\ ))
...
-- Equation(s):
-- \Add5~13_sumout\ = SUM(( \vsync_counter[9]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~70\ ))
-- \Add5~14\ = CARRY(( \vsync_counter[9]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~70\ ))
...
-- pragma translate_on
PORT MAP (
	datad => \ALT_INV_vsync_counter[9]~DUPLICATE_q\,
	cin => \Add5~70\,
...
-- Equation(s):
-- \Add5~65_sumout\ = SUM(( vsync_counter(10) ) + ( GND ) + ( \Add5~14\ ))
-- \Add5~66\ = CARRY(( vsync_counter(10) ) + ( GND ) + ( \Add5~14\ ))
...
-- Equation(s):
-- \Add5~61_sumout\ = SUM(( \vsync_counter[11]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~66\ ))
-- \Add5~62\ = CARRY(( \vsync_counter[11]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~66\ ))
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_vsync_counter[11]~DUPLICATE_q\,
	cin => \Add5~66\,
...
-- Equation(s):
-- \Add5~57_sumout\ = SUM(( \vsync_counter[12]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~62\ ))
-- \Add5~58\ = CARRY(( \vsync_counter[12]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~62\ ))
...
-- pragma translate_on
PORT MAP (
	datad => \ALT_INV_vsync_counter[12]~DUPLICATE_q\,
	cin => \Add5~62\,
...
-- Equation(s):
-- \Add5~53_sumout\ = SUM(( \vsync_counter[13]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~58\ ))
-- \Add5~54\ = CARRY(( \vsync_counter[13]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~58\ ))
...
-- pragma translate_on
PORT MAP (
	datac => \ALT_INV_vsync_counter[13]~DUPLICATE_q\,
	cin => \Add5~58\,
...
-- Equation(s):
-- \Add5~21_sumout\ = SUM(( \vsync_counter[14]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~54\ ))
-- \Add5~22\ = CARRY(( \vsync_counter[14]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~54\ ))
...
-- pragma translate_on
PORT MAP (
	datab => \ALT_INV_vsync_counter[14]~DUPLICATE_q\,
	cin => \Add5~54\,
...
-- Equation(s):
-- \Add5~117_sumout\ = SUM(( \vsync_counter[15]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~22\ ))
-- \Add5~118\ = CARRY(( \vsync_counter[15]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~22\ ))
...
-- Equation(s):
-- \Add5~113_sumout\ = SUM(( \vsync_counter[16]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~118\ ))
-- \Add5~114\ = CARRY(( \vsync_counter[16]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~118\ ))
...
-- pragma translate_on
PORT MAP (
	datad => \ALT_INV_vsync_counter[16]~DUPLICATE_q\,
	cin => \Add5~118\,
	sumout => \Add5~113_sumout\,
	cout => \Add5~114\);

-- Location: LABCELL_X56_Y2_N30
\vsync_counter[16]~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \vsync_counter[16]~feeder_combout\ = ( \Add5~113_sumout\ )
...
PORT MAP (
	...
	combout => \vsync_counter[16]~feeder_combout\);
...
PORT MAP (
	clk => \cmos_pixclk~inputCLKENA0_outclk\,
	d => \vsync_counter[16]~feeder_combout\,
	sclr => \Equal3~6_combout\,
	ena => \Equal2~6_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Add5~109_sumout\ = SUM(( vsync_counter(17) ) + ( GND ) + ( \Add5~114\ ))
-- \Add5~110\ = CARRY(( vsync_counter(17) ) + ( GND ) + ( \Add5~114\ ))
...
\vsync_counter[17]~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \vsync_counter[17]~feeder_combout\ = ( \Add5~109_sumout\ )
...
PORT MAP (
	...
	combout => \vsync_counter[17]~feeder_combout\);
...
PORT MAP (
	clk => \cmos_pixclk~inputCLKENA0_outclk\,
	d => \vsync_counter[17]~feeder_combout\,
	sclr => \Equal3~6_combout\,
	ena => \Equal2~6_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Add5~105_sumout\ = SUM(( \vsync_counter[18]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~110\ ))
-- \Add5~106\ = CARRY(( \vsync_counter[18]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~110\ ))
...
-- pragma translate_on
PORT MAP (
	datad => \ALT_INV_vsync_counter[18]~DUPLICATE_q\,
	cin => \Add5~110\,
	sumout => \Add5~105_sumout\,
	cout => \Add5~106\);

-- Location: LABCELL_X56_Y2_N48
\vsync_counter[18]~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \vsync_counter[18]~feeder_combout\ = ( \Add5~105_sumout\ )
...
PORT MAP (
	...
	combout => \vsync_counter[18]~feeder_combout\);
...
PORT MAP (
	clk => \cmos_pixclk~inputCLKENA0_outclk\,
	d => \vsync_counter[18]~feeder_combout\,
	sclr => \Equal3~6_combout\,
	ena => \Equal2~6_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \Add5~101_sumout\ = SUM(( vsync_counter(19) ) + ( GND ) + ( \Add5~106\ ))
-- \Add5~102\ = CARRY(( vsync_counter(19) ) + ( GND ) + ( \Add5~106\ ))
...
-- Equation(s):
-- \Add5~97_sumout\ = SUM(( vsync_counter(20) ) + ( GND ) + ( \Add5~102\ ))
-- \Add5~98\ = CARRY(( vsync_counter(20) ) + ( GND ) + ( \Add5~102\ ))
...
-- Equation(s):
-- \Add5~93_sumout\ = SUM(( vsync_counter(21) ) + ( GND ) + ( \Add5~98\ ))
-- \Add5~94\ = CARRY(( vsync_counter(21) ) + ( GND ) + ( \Add5~98\ ))
...
-- Equation(s):
-- \Add5~89_sumout\ = SUM(( vsync_counter(22) ) + ( GND ) + ( \Add5~94\ ))
-- \Add5~90\ = CARRY(( vsync_counter(22) ) + ( GND ) + ( \Add5~94\ ))
...
-- Equation(s):
-- \Add5~85_sumout\ = SUM(( \vsync_counter[23]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~90\ ))
-- \Add5~86\ = CARRY(( \vsync_counter[23]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~90\ ))
...
-- Equation(s):
-- \Add5~81_sumout\ = SUM(( vsync_counter(24) ) + ( GND ) + ( \Add5~86\ ))
-- \Add5~82\ = CARRY(( vsync_counter(24) ) + ( GND ) + ( \Add5~86\ ))
...
-- Equation(s):
-- \Add5~77_sumout\ = SUM(( vsync_counter(25) ) + ( GND ) + ( \Add5~82\ ))
-- \Add5~78\ = CARRY(( vsync_counter(25) ) + ( GND ) + ( \Add5~82\ ))
...
-- Equation(s):
-- \Add5~25_sumout\ = SUM(( vsync_counter(26) ) + ( GND ) + ( \Add5~78\ ))
-- \Add5~26\ = CARRY(( vsync_counter(26) ) + ( GND ) + ( \Add5~78\ ))
...
-- Equation(s):
-- \Add5~49_sumout\ = SUM(( vsync_counter(27) ) + ( GND ) + ( \Add5~26\ ))
-- \Add5~50\ = CARRY(( vsync_counter(27) ) + ( GND ) + ( \Add5~26\ ))
...
-- Equation(s):
-- \Add5~45_sumout\ = SUM(( vsync_counter(28) ) + ( GND ) + ( \Add5~50\ ))
-- \Add5~46\ = CARRY(( vsync_counter(28) ) + ( GND ) + ( \Add5~50\ ))
...
-- Equation(s):
-- \Add5~41_sumout\ = SUM(( vsync_counter(29) ) + ( GND ) + ( \Add5~46\ ))
-- \Add5~42\ = CARRY(( vsync_counter(29) ) + ( GND ) + ( \Add5~46\ ))
...
-- Equation(s):
-- \Add5~37_sumout\ = SUM(( vsync_counter(30) ) + ( GND ) + ( \Add5~42\ ))
-- \Add5~38\ = CARRY(( vsync_counter(30) ) + ( GND ) + ( \Add5~42\ ))
...
-- Equation(s):
-- \Add5~17_sumout\ = SUM(( \vsync_counter[31]~DUPLICATE_q\ ) + ( GND ) + ( \Add5~38\ ))
...
-- Equation(s):
-- \Equal3~5_combout\ = ( vsync_counter(9) & ( \vsync_counter[3]~DUPLICATE_q\ & ( (!\vsync_counter[4]~DUPLICATE_q\ & \vsync_counter[2]~DUPLICATE_q\) ) ) )
...
PORT MAP (
	...
	dataf => \ALT_INV_vsync_counter[3]~DUPLICATE_q\,
	combout => \Equal3~5_combout\);

-- Location: LABCELL_X56_Y2_N6
\Equal3~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \Equal3~6_combout\ = ( \Equal3~5_combout\ & ( \Equal3~4_combout\ & ( (!vsync_counter(31) & (\vsync_counter[0]~DUPLICATE_q\ & !\vsync_counter[1]~DUPLICATE_q\)) ) ) )
...
-- Equation(s):
-- \Equal3~3_combout\ = ( !vsync_counter(18) & ( !vsync_counter(19) & ( (!vsync_counter(15) & (!vsync_counter(16) & !vsync_counter(17))) ) ) )
...
PORT MAP (
	...
	datae => ALT_INV_vsync_counter(18),
	dataf => ALT_INV_vsync_counter(19),
...
-- Equation(s):
-- \Equal3~1_combout\ = ( !vsync_counter(7) & ( !vsync_counter(10) & ( (!vsync_counter(12) & (!vsync_counter(11) & (!vsync_counter(8) & !vsync_counter(13)))) ) ) )
...
-- Equation(s):
-- \Equal3~2_combout\ = ( !vsync_counter(21) & ( !vsync_counter(22) & ( (!vsync_counter(20) & (!vsync_counter(24) & (!vsync_counter(23) & !vsync_counter(25)))) ) ) )
...
PORT MAP (
	...
	datae => ALT_INV_vsync_counter(21),
	dataf => ALT_INV_vsync_counter(22),
...
-- Equation(s):
-- \Equal3~0_combout\ = ( !vsync_counter(29) & ( !vsync_counter(28) & ( (!vsync_counter(6) & (!\vsync_counter[5]~DUPLICATE_q\ & (!vsync_counter(30) & !vsync_counter(27)))) ) ) )
...
PORT MAP (
	...
	datae => ALT_INV_vsync_counter(29),
...
-- Equation(s):
-- \Equal3~4_combout\ = ( \Equal3~2_combout\ & ( \Equal3~0_combout\ & ( (\Equal3~3_combout\ & (\Equal3~1_combout\ & (!vsync_counter(26) & !vsync_counter(14)))) ) ) )
...
-- Equation(s):
-- \LessThan4~0_combout\ = ( vsync_counter(9) & ( \vsync_counter[3]~DUPLICATE_q\ & ( !vsync_counter(31) ) ) ) # ( !vsync_counter(9) & ( \vsync_counter[3]~DUPLICATE_q\ & ( (!vsync_counter(31) & ((!\Equal3~4_combout\) # (\vsync_counter[4]~DUPLICATE_q\))) ) ) ) 
-- # ( vsync_counter(9) & ( !\vsync_counter[3]~DUPLICATE_q\ & ( !vsync_counter(31) ) ) ) # ( !vsync_counter(9) & ( !\vsync_counter[3]~DUPLICATE_q\ & ( (!vsync_counter(31) & ((!\Equal3~4_combout\) # ((\vsync_counter[2]~DUPLICATE_q\ & 
-- \vsync_counter[4]~DUPLICATE_q\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010101100000000111111110000000010101111000000001111111100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
